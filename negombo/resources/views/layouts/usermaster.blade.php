...
<head>
  <title>{{ __('Welcome') }} &raquo; Negombo</title>
  <meta charset="utf-8">
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-B0F0XH5VDN"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-B0F0XH5VDN');
  </script>


</head>
	<nav class="navbar navbar-expand-lg" id="nav_bar_style">
	   <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('images/siteimages/logo-color.svg') }} " height="55px" width="250px"></a>
	      ...
	      <ul class="navbar-nav mr-auto">
	         ...
	         <li class="nav-item dropdown itmstyle">
                ...
                @foreach ($maparray['map_coods'] as $map_cood)
                  <a class="dropdown-item" href="{{ route('user.viewsmallplace', $map_cood->map_name) }}"><span>{{ $map_cood->map_name }}</span></a>
          ...
          <div class="row">
              ...
              <div class="col-xs-6 col-md-3">
                  ...
                  <ul class="list-unstyled quick-links margin_text-footer">
                      <li><a href="{{ route('user.index') }}"><i class="fa fa-angle-double-right"></i>{{ __('Home') }}</a></li>
                      {{-- <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>{{ __('Quick Booking') }}</a></li> --}}
                      <li><a href="{{ route('user.prices') }}"><i class="fa fa-angle-double-right"></i>{{ __('Price') }}</a></li>
